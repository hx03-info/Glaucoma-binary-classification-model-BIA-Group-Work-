...
def evaluate_convnext(model_path: str, val_dir: str, save_dir: str):
    ...
    # Save the plot to save directory
    plt.savefig(os.path.join(save_dir, 'convnext_evaluation_curves.png'), dpi=300, bbox_inches='tight')
    plt.close()
...
def convnext_integrate(MODEL_PATH, VAL_DIR, CSV_PATH, SAVE_DIR):
    ...
    plt.savefig(os.path.join(SAVE_DIR, 'integrated_model_curves.png'), dpi=300, bbox_inches='tight')
    plt.show()
...
if __name__ == '__main__':
    ...
    # CONVNEXT_MODEL_PATH = '/Users/apple/Desktop/BIA 4/convnext_tiny_glaucoma.pth'
