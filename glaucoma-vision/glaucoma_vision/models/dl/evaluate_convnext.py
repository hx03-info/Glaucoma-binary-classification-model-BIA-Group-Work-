...
def evaluate_convnext(
    ...
    """Evaluate ConvNeXt-Tiny model for glaucoma detection (unified format with all models)"""
    print("[ConvNeXt-Tiny Evaluator] Starting evaluation...")
    ...
    model = load_dl_model("convnext_tiny", model_path)
    ...
    print("\n" + "="*50)
    print("CONVNEXT-TINY (IMAGE ONLY) METRICS")
    print("="*50)
    ...
    print("\n" + "-"*50)
    print("ConvNeXt-Tiny Confusion Matrix (TN, FP, FN, TP)")
    print("-"*50)
